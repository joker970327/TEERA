...
chunk BIG_384_58_cmove(volatile BIG_384_58 f, BIG_384_58 g, int d)
{
    int i;
    chunk c0,c1,s,t;
    chunk r=CONDMS;
...
chunk BIG_384_58_cswap(volatile BIG_384_58 f, volatile BIG_384_58 g, int d)
{
    int i;
    chunk c0,c1,s,t,w;
    chunk r=CONDMS;
...
chunk BIG_384_58_dcmove(volatile DBIG_384_58 f, DBIG_384_58 g, int d)
{
    int i;
    chunk c0,c1,s,t;
    chunk r=CONDMS;
...
/* Swap a and b if d=1 
chunk BIG_384_58_cswap(BIG_384_58 a, BIG_384_58 b, int d)
{
    int i;
...
*/
/* Move g to f if d=1 
chunk BIG_384_58_cmove(BIG_384_58 f, BIG_384_58 g, int d)
{
    int i;
...
*/
/* Move g to f if d=1 
chunk BIG_384_58_dcmove(DBIG_384_58 f, DBIG_384_58 g, int d)
{
    int i;
    chunk e,w,r,ra,t,b = (chunk) - d;
    w=0;
...
void BIG_384_58_ctmod(BIG_384_58 b,BIG_384_58 m,int bd)
{
    int k=bd;
    BIG_384_58 r,c;
    BIG_384_58_copy(c,m);
...
/* Set b=b mod c */
/* SU= 16 */
void BIG_384_58_mod(BIG_384_58 b, BIG_384_58 m)
{
    int k=BIG_384_58_nbits(b)-BIG_384_58_nbits(m);
    if (k<0) k=0;
    BIG_384_58_ctmod(b,m,k);
}

// Set a=b mod m in constant time (if bd is known at compile time)
// bd is Max number of bits in b - Actual number of bits in m
void BIG_384_58_ctdmod(BIG_384_58 a, DBIG_384_58 b, BIG_384_58 m, int bd)
{
    int k=bd;
    DBIG_384_58 c,r;
    BIG_384_58_dscopy(c,m);
    BIG_384_58_dnorm(b);

    BIG_384_58_dshl(c,k);
    while (k>=0)
    {
        BIG_384_58_dsub(r, b, c);
        BIG_384_58_dnorm(r);
...
void BIG_384_58_dmod(BIG_384_58 a, DBIG_384_58 b, BIG_384_58 m)
{
    int k=BIG_384_58_dnbits(b)-BIG_384_58_nbits(m);
    if (k<0) k=0;
    BIG_384_58_ctdmod(a,b,m,k);
}

// a=b/m  in constant time (if bd is known at compile time)
// bd is Max number of bits in b - Actual number of bits in m
void BIG_384_58_ctddiv(BIG_384_58 a,DBIG_384_58 b,BIG_384_58 m,int bd)
{
    int d,k=bd;
    DBIG_384_58 c,dr;
    BIG_384_58 e,r;
...
void BIG_384_58_ddiv(BIG_384_58 a, DBIG_384_58 b, BIG_384_58 m)
{
    int k=BIG_384_58_dnbits(b)-BIG_384_58_nbits(m);
    if (k<0) k=0;
    BIG_384_58_ctddiv(a,b,m,k);
}

// a=a/m  in constant time (if bd is known at compile time)
// bd is Max number of bits in b - Actual number of bits in m
void BIG_384_58_ctsdiv(BIG_384_58 b,BIG_384_58 m,int bd)
{
    int d, k=bd;
    BIG_384_58 e,a,r,c;
    BIG_384_58_norm(b);
    ...
    while (k >= 0)
    {
        BIG_384_58_sub(r, a, c);
        BIG_384_58_norm(r);
        d = 1 - ((r[NLEN_384_58 - 1] >> (CHUNK - 1)) & 1);
        BIG_384_58_cmove(a, r, d);

        BIG_384_58_add(r, b, e);
        BIG_384_58_norm(r);
...
void BIG_384_58_sdiv(BIG_384_58 b, BIG_384_58 m)
{
    int k=BIG_384_58_nbits(b)-BIG_384_58_nbits(m);
    if (k<0) k=0;
    BIG_384_58_ctsdiv(b,m,k);
}
...
{
    return (int)((a[n / BASEBITS_384_58] & ((chunk)1 << (n % BASEBITS_384_58))) >> (n%BASEBITS_384_58));
...
void BIG_384_58_modmul(BIG_384_58 r, BIG_384_58 a1, BIG_384_58 b1, BIG_384_58 m)
{
    ...
    BIG_384_58_ctdmod(r, d, m, BIG_384_58_nbits(m));
}
...
void BIG_384_58_modneg(BIG_384_58 r, BIG_384_58 a1, BIG_384_58 m)
{
    ...
    BIG_384_58_copy(a, a1);
    BIG_384_58_mod(a, m);
    BIG_384_58_sub(r, m, a); BIG_384_58_norm(r);
}
